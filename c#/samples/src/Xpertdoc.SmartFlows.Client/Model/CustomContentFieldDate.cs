...
namespace Xpertdoc.SmartFlows.Client.Model
{
    ...
    public partial class CustomContentFieldDate :  IEquatable<CustomContentFieldDate>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CustomContentFieldDate);
        }

        /// <summary>
        /// Returns true if CustomContentFieldDate instances are equal
        /// </summary>
        /// <param name="other">Instance of CustomContentFieldDate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomContentFieldDate other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
