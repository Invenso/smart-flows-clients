...
namespace Xpertdoc.SmartFlows.Client.Model
{
    ...
    public partial class CustomContentFieldTime :  IEquatable<CustomContentFieldTime>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CustomContentFieldTime);
        }

        /// <summary>
        /// Returns true if CustomContentFieldTime instances are equal
        /// </summary>
        /// <param name="other">Instance of CustomContentFieldTime to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomContentFieldTime other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
