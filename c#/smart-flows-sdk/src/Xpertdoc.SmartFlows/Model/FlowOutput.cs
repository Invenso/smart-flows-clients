...
namespace Xpertdoc.SmartFlows.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FlowOutput : IEquatable<FlowOutput>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets FieldMap
        /// </summary>
        [DataMember(Name = "fieldMap", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FieldMap: ").Append(FieldMap).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlowOutput);
        }

        /// <summary>
        /// Returns true if FlowOutput instances are equal
        /// </summary>
        /// <param name="other">Instance of FlowOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlowOutput other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FieldMap != null)
                    hash = hash * 59 + this.FieldMap.GetHashCode();
                return hash;
            }
        }
