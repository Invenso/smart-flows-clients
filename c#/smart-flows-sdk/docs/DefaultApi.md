...
namespace Example
{
    public class PrepareImportExample
    {
        ...
        {
            var apiInstance = new DefaultApi();
            var body = BINARY_DATA_HERE;  // byte[] | The content of the archive (optional) 
...
namespace Example
{
    public class UpdateAssetContentExample
    {
        public void main()
        {
            ...
            var apiInstance = new DefaultApi();
            var assetId = assetId_example;  // string | The id of the asset
            var body = BINARY_DATA_HERE;  // byte[] | The content of the asset (optional) 
...
namespace Example
{
    public class UpdateTemplateContentExample
    {
        public void main()
        {
            ...
            var body = BINARY_DATA_HERE;  // byte[] | The content of the template (optional) 
